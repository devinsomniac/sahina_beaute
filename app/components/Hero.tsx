...
const Hero = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 min-h-[calc(100vh-5rem)] bg-gradient-to-br from-[#FDF6F0] via-[#f1d3d3] to-[#e6bcbc]'>
            ...
            >
                <div className={`${nunito.className} border-2 mt-4 md:mt-0 border-[#C9A84C] bg-burgundy/20 tracking-widest uppercase font-extralight px-4 rounded-full text-burgundy/90 flex gap-2 items-center text-xs md:text-sm`}>
